  ...
  <div class="container">
    ...
    <p>
      Permanecemos à disposição para quaisquer dúvidas ou esclarecimentos que se fizerem necessários.
        ...
        # A "NOTA GERAL" pode ser calculada ou manual. Se for calculada, o `disabled=True` é bom.
        # Se você quiser que o usuário *possa* editá-la, remova `disabled=True`.
        # Se for para ser calculada, o 'value' precisa ser o resultado do cálculo.
        # Por enquanto, mantive como input, lendo e escrevendo no session_state
